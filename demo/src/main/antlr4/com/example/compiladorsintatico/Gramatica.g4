...
comando : READ PARENTESES_ESQUERDO var_read PARENTESES_DIREITO |
          ...
          FOR id {System.out.println("{A25}");} ATRIBUICAO expressao {System.out.println("{A26}");} TO {System.out.println("{A27}");} expressao  {System.out.println("{A28}");}
          ...
          IF PARENTESES_ESQUERDO condicao PARENTESES_DIREITO {System.out.println("{A17}");} THEN BEGIN sentencas END {System.out.println("{A18}");} pfalsa? {System.out.println("{A19}");} |
          id {System.out.println("{A13}");} ATRIBUICAO expressao {System.out.println("{A14}");};
